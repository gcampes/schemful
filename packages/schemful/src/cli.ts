...
// Init command - initialize new Schemful project
program
  .command("init")
  .description("Initialize a new Schemful project")
  .option("--force", "Overwrite existing files")
  .action(async (options) => {
    try {
      console.log(chalk.blue("🚀 Initializing Schemful project..."));
...
program
  ...
  .option("--all", "Delete ALL content types, not just schemful-managed ones")
  .action(async (options) => {
    try {
