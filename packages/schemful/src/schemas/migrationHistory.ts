 ...
 *
 * Note: This is a system schema used internally by Schemful.
...
export const migrationHistorySchema: ContentTypeSchema = {
  id: "schemful_migration_history",
  name: "🔄 Schemful Migration History",
  description:
    "Tracks executed Schemful migrations - managed automatically by Schemful CLI",
