---
title: Examples
description: Overview of the example schemas included in the Schemful repository, covering blog, e-commerce, landing page, and portfolio patterns.
---

The Schemful repository includes complete example schemas for common content modeling patterns. Each example demonstrates different field types, validations, and relationships.
...
The examples live in `packages/schemful/examples/` in the Schemful repository. You can use them as:
...
- **Learning material** — read through the schemas to understand the full range of field types and validators Schemful supports.
