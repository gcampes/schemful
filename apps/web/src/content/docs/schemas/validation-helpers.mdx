...
Schemful ships two sets of helper functions that return validation objects. Use them instead of writing raw validation objects to keep your schemas readable and typo-free.
...
```ts
import { richTextValidators } from "schemful";
```
