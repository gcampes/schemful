---
title: Field Types
description: Complete reference of all 14 Contentful field types and how to define them in Schemful schemas.
---

Schemful supports all 14 Contentful field types. Each field is a TypeScript object with at minimum an `id`, `name`, `type`, and `required` property.

## Type overview

| Contentful type | Schemful `type` | Description |
|---|---|---|
